...
$liga = "indicadores/facturacion.php?Emisor=".$_POST['razonSocial']."&Ejecutivo=".$_POST['ejecutivo']."&Cliente=".$_POST['cliente']."
    &FechaInicio=".$_POST['fechaInicio']."&fechaFinal=".$_POST['fechaFinal'];
?>
<!DOCTYPE html>
<html>
    <head>
