...
include_once("../WEB-INF/Classes/EquiposCaracteristicasFormatoServicios.class.php");
            ...
            <tr>
                ...
                <td style="width: 50%">
                    ...
                    if ($tipoReporte != "15") {
                        ...
                        echo "<table style='width: 100%'><tr>";
                        echo "<td align='right' style='font-size:12px;font-family:Arial;'><b>Fecha levantamiento de $nombre_objeto: </b></td><td align='left'>$fechaTicket $horaTicket</td>";
                        echo "</table>";
                    }
                    ?>
                </td>
