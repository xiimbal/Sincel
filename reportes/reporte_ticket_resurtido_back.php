...
<html lang="es">
    ...
    <body style="font-size:12px;font-family:Arial;height:50%;">
                    ...
                    <?php 
                        while($rs = mysql_fetch_array($query)){
                            ...
                            if($compatible){
                                ...
                                echo "<td align='center'>".$rs['ModeloT']."</td>";
                            }
        ...
        ?>
        <fieldset>
            <legend><b>Surtido previo de este ticket</b></legend> 
            <table style="width: 40%;height: 40px;" class="BorderTabla">
                ...
                <tbody style="background-color: #D3D6FF;">
                <?php
                    foreach($arrayCantidadComponente as $key => $value){
                        echo "<tr>";
                        echo "<td>$value</td>";
                        echo "<td>".$arrayComponenteModelo[$key]."</td>";
                        echo "<td>".$key."</td>";
                        echo "<td>".$arrayFechaComponente[$key]."</td>";
                        echo "</tr>";
                    }
                ?>
                </tbody>
