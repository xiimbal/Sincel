...
<html lang="es">
    ...
    <body>
        <div class="principal">                     
            ...
            <br/>
            <form id="FormLectura" name="FormLectura" action="reportes/ReporteLecturaPDF.php" target="_blank" method="POST">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="anexo" name="anexo" width="150" style="width: 100px" class="select" onchange="cargarLectura();">
                        ...
                        <td><input type="text" class="fecha" id="fecha" name="fecha" /></td>
                    </tr>
                </table>
                <br/><br/>
                ...
                <input type="submit" class="button" id="submit_lecturas2" name="submit_lecturas1" value="Generar reporte" style="margin-left: 85%; display: none;"/>               
            </form>                        
        </div>        
    </body>
</html>