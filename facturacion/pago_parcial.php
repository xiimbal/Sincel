...
<script lang="text/javascript">
    cambiarContenidos("list_pago_parcial.php?RFC=<?php echo $_GET['RFC']; ?>&factura=<?php echo $_GET['factura']; ?><?php echo $pagada."".$cxc."".$cfdi; ?>", "Pago Parcial Factura <?php echo $factura->getSerie().$factura->getFolio(); ?>");
</script>