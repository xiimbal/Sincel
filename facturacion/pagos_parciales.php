...
<?php 
    $alta = "Alta_Multi_Pago.php?RFC=" . $_GET['RFC']."&factura=".$_GET['factura']."".$pagada."".$cxc."".$cfdi;
    $lista = "list_pagos_parciales.php?RFC=".$_GET['RFC']."&factura=".$_GET['factura']."". $pagada."".$cxc."".$cfdi;
    //echo "FACTURAS ". $_GET['factura'];
?>
<script lang="text/javascript">
    //cambiarContenidos("list_pagos_parciales.php?RFC=<?php //echo $_GET['RFC']; ?>&factura=<?php //echo $_GET['factura']; ?><?php //echo $pagada."".$cxc."".$cfdi; ?>", "Pago Parcial Factura <?php //echo $factura->getSerie().$factura->getFolio(); ?>");
    //cambiarContenidos("<?php //echo $alta; ?>", "Nuevo pago parcial");
    cambiarContenidos("<?php echo $lista;?>","Lista de pagos multiples");
</script>