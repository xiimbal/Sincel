...
if (isset($_POST['form'])) {
    ...
    $cabeceras = Array("Folio", "Fecha", "Nombre Receptor", "Nombre Emisor", "Subtotal", "Importe", "Total", "Estado de factura", "RFC", "Tipo de comprobante", "", "");
    $columnas = Array("Folio", "FechaFacturacion", "NombreReceptor", "NombreEmisor", "subtotal", "importe", "Total", "EstadoFactura", "RFCReceptor", "TipoComprobante");
    ?>
    <script type="text/javascript" language="javascript" src="resources/js/paginas/facturacion/TablaPDF.js"></script>
