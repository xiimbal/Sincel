        ...
        <div class="container-fluid">      
            <form action="compras/XML_orden_compra.php" method="POST" target="_blank" id="FormularioExportacion">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label>Surtidos</label><br>
                        <input type="checkbox" id="ckSurtido" name="ckSurtido" <?php echo $surtido; ?> />
                    </div>
                    <div class="form-group col-md-3">
                        <label>Fecha inicio:</label><br>
                        <input class="form-control" type="date" id="txtFechaInicioL" name="txtFechaInicioL" value="<?php echo $fechaInicio; ?>"/>
                    </div>
                    <div class="form-group col-md-3">
                        <label>fecha Fin:</label><br>
                        <input class="form-control" type="date" id="txtFechaFinL" name="txtFechaFinL" value="<?php echo $fechaFin; ?>"/>
                    </div>
                    <div class="form-group col-md-3">
                        <label>Estatus:</label>
                    ...
                    <div class="form-group col-md-3">
                        <label><?php echo $nombre_objeto?></label><br>
                        <input type="checkbox" id="ckTickets" name="ckTickets" <?php echo $tickets?>>
                    </div>
                    <div class="form-group col-md-3">
                        <label>Cancelados</label><br>
                        <input type="checkbox" id="ckCancelados" name="ckCancelados" <?php echo $cancelados; ?>/>
                    </div>
                </div> 

            </form>
            <input type="button" class="botonExcel button btn btn-lg btn-block btn-outline-success mt-3 mb-3" title="Exportar a excel" id="excelSubmit" name="excelSubmit" value="Exportar a excel" onclick="ExportarOCExcel()"/>
            <input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />
            <input type="button" class="button btn btn-lg btn-block btn-outline-primary mt-3 mb-3" style="float: left" value="Buscar" onclick="buscarOrdenCompra();"/>
            	...
            	if ($_SESSION['idEmpresa'] == '13') {
            		...
            		?>
            			<table id="tAlmacen" style="min-width:100%">
			                <thead>
			                    <tr>
			                        <th align='center' scope='row' >Orden de compra</th>
			                        <th align='center' scope='row' >No. pedido</th>
			                        <th align='center' scope='row' >Fecha</th>
			                        <th align='center' scope='row' >Proveedor</th>
			                        <th align='center' scope='row' >Estatus</th>
			                        <th align='center' scope='row' >Cantidad Eq,Comp,Servicios o Productos</th>
			                        <th align='center' scope='row' >Viáticos</th>
			                        <th align='center' scope='row' >Evidencia</th>
			                        <th align='center' scope='row' >Editar</th>
			                        <th align='center' scope='row' >Eliminar</th>
			                        <th align='center' scope='row' >Imprimir</th>
			                ...
			                <tbody>
			                   ...
			                   <!-- <td align='center' scope='row'>
			                        <?php 
			                       /* $muestra_comentario = "SELECT coment FROM c_evidencia WHERE id_eve =  ".$rs['Id_orden_compra'].";";
			                        $query3 = $catalogo->obtenerLista($muestra_comentario);
			                        //print_r($muestra_comentario);
			                    ...
			                    <td align='center' scope='row'>
			                        <?php if ($permisos_grid->getModificar()) { 
			                            ...
			                            ?>
			                            <a href='#' onclick='
			                                    window.location = "principal.php?mnu=compras&action=mostrar_evidencia&id=<?php echo $rs['Id_orden_compra']; ?>";
			                                    return false;
			                               ' title='Evidencia' ><img src="resources/images/icon_imag.png" width="25" height="25"/></a>
			                           <?php
			                                //}
			                           } ?>
			                    </td>
