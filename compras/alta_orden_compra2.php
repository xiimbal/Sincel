    ...
    <body>
        ...
        <form id="frmOrdenCompra" name="frmOrdenCompra" action="/" method="POST">
            <div class="form-row">
                    <?php
                    if ($idOrdenCompra != "") {
                        echo "<div class='form-group col-md-3'><h2>Orden de compra $idOrdenCompra</h2></div>";
                    }
                    ?>  
                <div class="form-group col-md-3">
                    <label>Copiar orden de compra</label>
                    <select class="form-control" id="slOrdenCompra" name="slOrdenCompra">
                ...
                <input type="button" class="button btn btn-lg btn-block btn-outline-primary mt-3 mb-3" value="Copiar" onclick="CopiarOrdenCompra(); return false;"/>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="slProveedor" name="slProveedor" <?php echo $disabled; ?> onchange="mostrarDireccionProveedor(this.value)">
                ...
                <div class="form-group col-md-3">
                    <label>Factura a:<span style="color: red">*</span></label>
                    <select class="form-control" id="slRazonSocial" name="slRazonSocial" <?php echo $disabled; ?> onchange="mostrarDireccionFacturacion(this.value)">
                        <option value="0">Selecione un opción</option>
                        <?php
                    ...
                    <input type="text" class="form-control"  id="txtdireccionFactra" name="txtdireccionFactra" readonly value="<?php echo $direccionRazon; ?>"/>
                </div>
                <div class="form-group col-md-3">
                    <label>Embarca a :<span style="color: red">*</span></label>
                    <select class="form-control" id="slAlmacen" name="slAlmacen" <?php echo $disabled; ?> onchange="mostrarDireccionAlmacen(this.value)">
                        <option value="0">Selecione un opción</option>
                        <?php
                    ...
                    <input type="text" class="form-control"  id="txtdireccionEmbarca" name="txtdireccionEmbarca" style="width:100%" value="<?php echo $embarque; ?>"/>
                </div>
                <div class="form-group col-md-3">
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label>Fecha pedido:<span style="color: red">*</span></label>
                    <input class="form-control" type="date" id="txtfechaOrden" name="txtfechaOrden" value="<?php echo $fecha; ?>" <?php echo $disabled; ?>/>
                </div>     
                <div class="form-group col-md-3">
                    <label>Forma de pago:<span style="color: red">*</span></label>
                    <select class="form-control" id="slFormaPago" name="slFormaPago" <?php echo $disabled; ?>>
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="slEstatus" name="slEstatus" <?php echo $desactivarEstatus ?>>
                        <option value="0">Selecione un opción</option>
                        <?php
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" readonly id="txtNoCliente" name="txtNoCliente" value="<?php echo $noCliente; ?>" <?php echo $disabled; ?>/>
                </div>
                <div class="form-group col-md-3">
                    <label>No. pedido distribuidor:</label>
                    <input type="text" class="form-control" id="txtPedidoProv" name="txtPedidoProv" value="<?php echo $noprov; ?>" <?php echo $disabled; ?>/>
                </div>
                <div class="form-group col-md-3">
                    <label>Notas:</label>
                    <input type="text" class="form-control" id="txtNotas" name="txtNotas" value="<?php echo $notas; ?>" <?php echo $disabled; ?>/>
                </div>
                <div class="form-group col-md-3">
                    <label>Transportista:</label>
                    <select class="form-control" id="slMensajeria" name="slMensajeria">
                        <option value="0">Selecione un opción</option>
                        <?php
                ...
                <div class="form-group col-md-3">
                    <label>Peso Kg:</label>
                    <input type="text" class="form-control" id="txtPeso" name="txtPeso" value="<?php echo $peso; ?>" <?php echo $disabled; ?>/>
                </div>
                <div class="form-group col-md-3">
                    <label>Metros cúbicos:</label>
                    <input type="text" class="form-control" id="txtMetros" name="txtMetros" value="<?php echo $metros; ?>" <?php echo $disabled; ?>/>
                </div>
                <div class="form-group col-md-3">
                    <label>Origen:</label>
                    <input type="text" class="form-control" id="txtOrigen" name="txtOrigen" value="<?php echo $origen; ?>" <?php echo $disabled; ?>/>
                </div>
                <div class="form-group col-md-3">
                    <label>Método de entrega:</label>
                    <input type="text" class="form-control" id="txtMetodo" name="txtMetodo" value="<?php echo $metodo; ?>" <?php echo $disabled; ?>/>
                </div>
                <div class="form-group col-md-3">
                    <label>Dólar</label>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="txtTipoCambio" name="txtTipoCambio" value="<?php echo $tipoCambio; ?>"/><br/>
            ...
            <fieldset>
                ...
                <input type="button" id="btnImport" name="btnImport" class="btn" value="Importar componentes backorder" title="Importar componentes backorder"  onclick="importarComponentes();"/>
                <br/>
            ...
            <fieldset>
                ...
                <table style="width: 98%">
                    <tr>
                        ...
                        <td><input type="text" class="form-control" id="subtotalTicket" name="subtotalTicket" value="<?php echo $SubtotalTicket?>" readonly></td>
                        <td><label for="totalTicket">Total Ticket</label></td>
                        <td><input type="text" class="form-control" id="totalTicket" name="totalTicket" value="<?php echo $TotalTicket?>" readonly></td>
                    </tr>
                </table>
            </fieldset>
            <?php }?>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" id='txtObservaciones' name="txtObservaciones"><?php echo $observacion; ?></textarea>
                </div>
                ...
                <input type="submit" class="button btn btn-lg btn-block btn-outline-success mt-3 mb-3" value="Guardar"/>
                <input type="button" class="button btn btn-lg btn-block btn-outline-danger mt-3 mb-3" value="Cancelar" onclick="window.location = 'principal.php?mnu=compras&action=lista_orden_compra'; return false;"/>
            </div>          
        </form>
    </body>
</div>
