...
$same_page = "admin/lista_gZona.php";
$permisos_grid->getPermisosSubmenu($_SESSION['idUsuario'], $same_page);

$controlador = $_SESSION['ruta_controler'] . "Controler_GZona.php";

$cabeceras = array("Nombre", "Descripcion", "Estatus","", "");
$columnas = array("nombre", "descripcion", "id_gzona");
$tabla = "c_gzona";
$order_by = "nombre";
$alta = "admin/alta_gZona.php";
?>
<!DOCTYPE html>
<html lang="es">
    <head>
