            ...
            <table id="tAlmacen" class="tabla_datos" style="width: 100%">
                <thead>
                    <tr style="font-size: 10px">
                        ...
                        <td align='center' scope='row'>Incluidas B/N</td>
                        <td align='center' scope='row'>Incluidas color</td>
                        <td align='center' scope='row'>Excedentes B/N </td>
                        <td align='center' scope='row'>Excedentes color</td>
                        <td align='center' scope='row'>Costo página B/N</td>
                        <td align='center' scope='row'>Costo página color</td>
