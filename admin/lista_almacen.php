...
//                        }
                    ...
                    <td align='center' scope='row'> 
                        <?php if ($permisos_grid->getModificar()) { ?>
                            <a href='#' onclick='editarRegistro("admin/lista_almacenZona.php", "<?php echo $rs[$columnas[count($columnas) - 1]]; ?>");
                            return false;' title='Detalle zona' ><img src="resources/images/Apply.png"/></a>
                        <?php } ?>
                    </td>
                    <td align='center' scope='row'>                        
                        <?php if ($permisos_grid->getModificar()) { ?>
