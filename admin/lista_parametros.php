...
$same_page = "admin/lista_parametros.php";
$permisos_grid->getPermisosSubmenu($_SESSION['idUsuario'], $same_page);

$controlador = $_SESSION['ruta_controler'] . "Controler_Parametros.php";

$cabeceras = array("Descripcion", "Valor","Comentario" , "Estatus","");
$columnas = array("Descripcion", "Valor", "Comentario" ,"IdParametro");
$tabla = "c_parametro";
$order_by = "Descripcion";
$alta = "admin/alta_parametros.php";
?>
<!DOCTYPE html>
<html lang="es">
    <head>
                ...
                <tbody>
                    ...
                    while ($rs = mysql_fetch_array($query)) {
                        echo "<tr>";
                            ...
                            echo "<td align='center' scope='row'>" . $rs['Valor'] . "</td>";
                            echo "<td align='center' scope='row'>" . $rs['Comentario'] . "</td>";
                            if ($rs['Activo'] == 1)
