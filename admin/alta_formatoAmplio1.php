    ...
    <body>
        <div class="principal">
            ...
            <form id="formFormatoAmpl" name="formFormatoAmpl" action="/" method="POST">
                <table>
                    <tr>
                        <td><label for="nombre">Nombre de esquema</label></td><td><input type="text" id="nombre" name="nombre" value="<?php echo $nombre; ?>"/></td>
                        <td colspan="2"><label for="tipo">Tipo</label>&nbsp;<input type="text" id="tipo" name="tipo" value="<?php echo $tipo; ?>" style="width: 350px;"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="incluidaBN" id="incluidaBN" <?php echo $incluidoBN; ?>/>ML Páginas incluidas B/N</td>
                        <td><input type="checkbox" name="incluidaColor" id="incluidaColor" <?php echo $incluidoColor; ?>/>ML Páginas incluidas color</td>
                        <td><input type="checkbox" name="excedenteBN" id="excedenteBN" <?php echo $excedenteBN; ?>/>ML Página excedente  B/N </td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" name="excedenteColor" id="excedenteColor" <?php echo $excedenteColor; ?>/>ML Página excedente color</td>
                        <td><input type="checkbox" name="costoBN" id="costoBN" <?php echo $costoBN; ?>/>Costo por ML página procesada B/N</td>
                        <td><input type="checkbox" name="costoColor" id="costoColor" <?php echo $costoColor; ?>/>Costo por ML página procesada color</td>
