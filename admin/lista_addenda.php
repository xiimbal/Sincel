...
$same_page = "admin/lista_addenda.php";
$permisos_grid->getPermisosSubmenu($_SESSION['idUsuario'], $same_page);

$cabeceras = array("Addenda","Detalle","","");
$columnas = array("Addenda","id_addenda");
$controlador = $_SESSION['ruta_controler'] . "Controler_Addenda.php";
$tabla = "c_addenda";
$order_by = "id_addenda";
$alta = "admin/alta_addenda.php";
?>
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <div class="principal">
            ...
            <table id="tAlmacen" class="tabla_datos">
                ...
                <tbody>
                    ...
                    $query = $catalogo->obtenerLista("SELECT c.nombre_addenda, c.id_addenda, (GROUP_CONCAT(CONCAT(k.campo,'=',k.valor) SEPARATOR ', ')) AS detalle
                        FROM `c_addenda` AS c
                        LEFT JOIN k_addenda AS k ON k.id_addenda = c.id_addenda
                        WHERE c.Activo = 1
                        GROUP BY c.id_addenda
                        ORDER BY c.id_addenda;");
                    while ($rs = mysql_fetch_array($query)) {
                        echo "<tr>";                        
                        echo "<td align='center' scope='row'>" . $rs['nombre_addenda'] . "</td>";                        
                        echo "<td align='center' scope='row'>" . $rs['detalle'] . "</td>";                        
                        ?>
