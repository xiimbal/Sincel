            ...
            <table id="tAlmacen" class="tabla_datos" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <td align='center' scope='row'> 
                        ...
                        <a href='#' onclick='editarRegistroProv("<?php echo $alta; ?>", "<?php echo $rs['IdPuesto']; ?>", "<?php echo $rs['id_sub']; ?>");
                    ...
                    <td align='center' scope='row'> 
                        ...
                        <a href='#' onclick='eliminarRegistroProv("<?php echo $controlador . "?id=" . $rs['IdPuesto'] . "&id2=" . $rs['id_sub'] ?>", "<?php echo $rs['IdPuesto']; ?>", "<?php echo $same_page; ?>");
