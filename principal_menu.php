...
<html lang="es">
    ...
    <body>     
        ...
        <div class="page">
            ...
            <div class="mt-5 main" style="margin: auto; width: 98%;">
            ...
            <div class="DivEncabezado color4">                        
...
<script >
    ...
    <?php if (isset($_GET['mnu']) && $_GET['mnu'] != "" && isset($_GET['action']) && $_GET['action'] != "" && isset($_GET['tipo']) && $_GET['tipo'] != "" && isset($_GET['tipoFac']) && $_GET['tipoFac'] != "") { 
            ...
            if(isset($_GET['id']) && isset($_GET['tipo']) && isset($_GET['tipoFac'])){                        
                $paginaCargar .= "id=".$_GET['id']."&tipo=".$_GET['tipo']."&idfacAsust=".$_GET['idfacAsust']."&tipoFac=".$_GET['tipoFac']."&";
            }
