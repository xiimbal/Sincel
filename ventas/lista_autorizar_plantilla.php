...
$filtroCampania = "";
if (isset($_POST['CampaniaFiltro']) && $_POST['CampaniaFiltro'] > 0) {
    $filtroCampania = $_POST['CampaniaFiltro'];
    $where = " WHERE cd.IdCampania='$filtroCampania' ";
}

$filtroTurno = "";
if (isset($_POST['TurnoFiltro']) && $_POST['TurnoFiltro'] != "") {
    $filtroTurno = $_POST['TurnoFiltro'];
    if ($where == "") {
        $where .= " WHERE ct.IdTurno='$filtroTurno' ";
    } else {
        $where .= " AND ct.IdTurno='$filtroTurno' ";
    }
}
                        ...
                        <fieldset>
                            ...
                            <table>
                                <tr>
                                    <td>Campaña</td>
                                    <td>
                                        <select id="CampaniaFiltro2" name="CampaniaFiltro2">
                                    ...
                                    <td>Turno</td>
                                    <td>
                                        <select id="TurnoFiltro2" name="TurnoFiltro2">
                                            <option value="0">Seleccione un Turno</option>
                                            <?php
                                            $catalogo = new Catalogo();
                                            $queryTurno = $catalogo->getListaAlta("c_turno", "descripcion");
