        ...
        <fieldset>
            ...
            <fieldset>
                ...
                <div id="div_serviciogim">
                    ...
                    onclick='cambiarContenidoServicio("div_serviciogim","ventas/validacion/alta_servicio_im.php?prefijo=GIM&CC=<?php echo $CC; ?>&Anexo=<?php echo $ClaveAnexo; ?>",
                        ...
                        <?php
                            ...
                            while($rs = mysql_fetch_array($result)){
                                ...
                                echo "<td align='center' scope='row'><a href='#' 
                                    onclick='cambiarContenidoServicio(\"div_serviciogim\",\"ventas/validacion/alta_servicio_im.php?prefijo=GIM&&CC=$CC&Anexo=$ClaveAnexo\",
                                        true,\"$ClaveAnexo;\",\"".$rs['IdKServicioGIM']."\"); return false;'>
                                    <img src=\"".$back."resources/images/Apply.png\"/></a></td>";
                                echo "<td align='center' scope='row'><a href='#' onclick='eliminarServicioGIM(\"".$rs['IdKServicioGIM']."\",\"servicios_g2\",\"lista_servicios_im.php\",\"$ClaveAnexo\",\"$CC\"); return false;'><img src=\"".$back."resources/images/Erase.png\"/></a></td>";
                                echo "</tr>";                            
                            }
                        ?>
                    </table>
            ...
            <fieldset>
                ...
                <div id="div_serviciogfa">
                    <img class="imagenMouse" src="<?php echo $back; ?>resources/images/add.png" title="Nuevo servicio" 
                    onclick='cambiarContenidoServicio("div_serviciogfa","ventas/validacion/alta_servicio_im.php?prefijo=GFA&CC=<?php echo $CC; ?>&Anexo=<?php echo $ClaveAnexo; ?>",
                                true,"<?php echo $ClaveAnexo; ?>",null);' style="float: right; cursor: pointer;" />
                    ...
                    <table class="filtro" style="min-width: 100%;">
                        ...
                        <?php
                            ...
                            while($rs = mysql_fetch_array($result)){
                                ...
                                echo "<td align='center' scope='row'><a href='#' 
                                    onclick='cambiarContenidoServicio(\"div_serviciogfa\",\"ventas/validacion/alta_servicio_im.php?prefijo=GFA&&CC=$CC&Anexo=$ClaveAnexo\",
                                        true,\"$ClaveAnexo;\",\"".$rs['IdKServicioGFA']."\"); return false;'>
                                    <img src=\"".$back."resources/images/Apply.png\"/></a></td>";
                                echo "<td align='center' scope='row'><a href='#' onclick='eliminarServicioGFA(\"".$rs['IdKServicioGFA']."\",\"servicios_g2\",\"lista_servicios_im.php\",\"$ClaveAnexo\",\"$CC\"); return false;'><img src=\"".$back."resources/images/Erase.png\"/></a></td>";
                                echo "</tr>";                            
                            }
                        ?>
                    </table>
