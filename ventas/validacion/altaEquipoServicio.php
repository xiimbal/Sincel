...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="<?php echo $back; ?>resources/js/paginas/validacion/altaEquipoServicio.js"></script>
        <style>
            .chico{width: 80px;}
        </style>
    </head>
    <body>        
        <fieldset>
            ...
            <form id="formEquipos" name="formEquipos" action="/" method="POST">                
                ...
                onclick="cargarDependencia('equipos_p2','<?php echo $back; ?>ventas/validacion/lista_equiposServicio.php','<?php echo $IdKServicio ?>',null,'<?php echo $prefijo_menor; ?>');  
                return false;"/>
