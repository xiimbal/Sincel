...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="<?php echo $back; ?>resources/js/paginas/validacion/alta_anexo.js"></script>
    </head>
    <body>
        <fieldset>
            <legend>Anexo</legend>
            <form id="formAnexo" name="formAnexo" action="/" method="POST">
                ...
                <input type="submit" id="cancelar_anexo" class="boton" value="Cancelar" style="float: right; margin-right: 5px;" onclick="cambiarContenidoValidaciones('anexo2', '<?php echo $back; ?>ventas/validacion/lista_anexo.php?idCliente=<?php echo $_GET['idCliente'] ?>',  <?php  if(isset($_POST['idTicket'])){ echo "'".$_POST['idTicket']."'";} else{ echo "null"; } ?>, '<?php echo $ClaveGET; ?>' , null);return false;"/>
