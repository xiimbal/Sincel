...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="<?php echo $back; ?>resources/js/paginas/validacion/lista_domicilio.js"></script>        
    </head>
    <body>        
        <fieldset>
            <?php
            ...
            <?php if($numero_domicilios == 0 && $permisos_grid->getAlta()){?>
                <img class="imagenMouse" src="<?php echo $back; ?>resources/images/add.png" title="Nuevo domicilio" onclick='cambiarContenidoValidaciones("domicilio2", "<?php echo $back; ?>ventas/validacion/alta_domicilio.php?Nuevo=true&id=<?php echo $ClaveCC; ?>&idCliente=<?php echo $ClaveCliente ?>", $("#idTicket").val(), null, true);
            ...
            while ($rs = mysql_fetch_array($query)) {
                ...
                echo "<td align='center' scope='row'><input type='radio' id='check_domicilio_".$rs['ClaveEspecialDomicilio']."' name='check_domicilio' 
                    onclick='cargarDependencia(\"contacto2\",\"".$back."ventas/validacion/lista_contacto.php\",\"".$rs['ClaveEspecialDomicilio']."\",\"check_domicilio_".$rs['ClaveEspecialDomicilio']."\",\"".$_POST["idTicket"]."\"); '/></td>";
                ...
                echo "<a href='#' onclick='cambiarContenidoValidaciones(\"domicilio2\",\"".$back."ventas/validacion/alta_domicilio.php?id=".$ClaveCC."&idCliente=".$ClaveCliente."\", $(\"#idTicket\").val(),\"" . $rs['IdDomicilio'] . "\",false); return false;'>";
