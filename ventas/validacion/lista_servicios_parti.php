...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="<?php echo $back; ?>resources/js/paginas/validacion/lista_servicio_im.js"></script>
        <style>
        ...
        <fieldset>
            ...
            <!--<a href="<?php //echo $liga; ?>" target="_blank" >Edita los servicios</a>-->            
                ...
                <div id="div_servicioim">
                    ...
                    <img class="imagenMouse" src="<?php echo $back; ?>resources/images/add.png" title="Nuevo servicio" 
                    onclick='cambiarContenidoServicio("div_servicioim","ventas/validacion/alta_servicio_im.php?CC=<?php echo $CC; ?>&Anexo=<?php echo $ClaveAnexo; ?>",
                    ...
                    <table class="filtro" style="min-width: 100%;">
                        ...
                        <?php
                            ...
                            while($rs = mysql_fetch_array($result)){
                                ...
                                echo "cargarDependencia(\"equipos_p2\",\"".$back."ventas/validacion/lista_equiposServicio.php\",\"".$rs['IdKServicioIM']."\",\"check_servicioim_".$rs['IdKServicioIM']."\",\"im\");";
                                echo "'/></td>";
                                ...
                                echo "<td align='center' scope='row'>"; 
                                echo "<a href='#' 
                                        onclick='cambiarContenidoServicio(\"div_servicioim\",\"ventas/validacion/alta_servicio_im.php?prefijo=IM&CC=$CC&Anexo=$ClaveAnexo\",
                                ...
                                if($permisos_grid->tienePermisoEspecial($_SESSION['idUsuario'],17)){
                                    echo "<a href='#' onclick='eliminarServicioIM(\"".$rs['IdKServicioIM']."\",\"servicios_p2\",\"lista_servicios_parti.php\",\"$ClaveAnexo\",\"$CC\"); return false;'><img src=\"".$back."resources/images/Erase.png\"/></a>"; 
                                }
                                echo "</td>";
                                echo "</tr>";                            
                            }
                        ...
                        <?php
                            ...
                            while($rs = mysql_fetch_array($result)){
                                ...
                                echo "<td align='center' scope='row'>
                                    ...
                                    onclick='$(\"#mensaje_equipos\").empty();"; 
                                echo "cargarDependencia(\"equipos_p2\",\"".$back."ventas/validacion/lista_equiposServicio.php\",\"".$rs['IdKServicioFA']."\",\"check_serviciofa_".$rs['IdKServicioFA']."\",\"fa\");";
                                echo "'/></td>";
                                ...
                                echo "<td align='center' scope='row'>"; 
                                echo "<a href='#' 
                                        onclick='cambiarContenidoServicio(\"div_servicioim\",\"ventas/validacion/alta_servicio_im.php?prefijo=FA&CC=$CC&Anexo=$ClaveAnexo\",
                                ...
                                echo "<td align='center' scope='row'>"; 
                                if($permisos_grid->tienePermisoEspecial($_SESSION['idUsuario'],17)){
                                    echo "<a href='#' onclick='eliminarServicioFA(\"".$rs['IdKServicioFA']."\",\"servicios_p2\",\"lista_servicios_parti.php\",\"$ClaveAnexo\",\"$CC\"); return false;'><img src=\"".$back."resources/images/Erase.png\"/></a>"; 
                                }
                                echo "</td>";
                                echo "</tr>";                            
                            }
                        ...
                        <?php
                            ...
                            while($rs = mysql_fetch_array($result)){
                                ...
                                echo "<td align='center' scope='row'>
                                    ...
                                    onclick='$(\"#mensaje_equipos\").empty();"; 
                                echo "cargarDependencia(\"equipos_p2\",\"".$back."ventas/validacion/lista_equiposServicio.php\",\"".$rs['IdKServicioGIM']."\",\"check_serviciogim_".$rs['IdKServicioGIM']."\",\"gim\");";
                                echo "'/></td>";
                                ...
                                echo "<td align='center' scope='row'>"; 
                                echo "<a href='#' 
                                        onclick='cambiarContenidoServicio(\"div_servicioim\",\"ventas/validacion/alta_servicio_im.php?prefijo=GIM&&CC=$CC&Anexo=$ClaveAnexo\",
                                ...
                                echo "<td align='center' scope='row'>"; 
                                if($permisos_grid->tienePermisoEspecial($_SESSION['idUsuario'],17)){
                                    echo "<a href='#' onclick='eliminarServicioGIM(\"".$rs['IdKServicioGIM']."\",\"servicios_p2\",\"lista_servicios_parti.php\",\"$ClaveAnexo\",\"$CC\"); return false;'><img src=\"".$back."resources/images/Erase.png\"/></a>"; 
                                }
                                echo "</td>";
                                echo "</tr>";                            
                            }
                        ...
                        <?php
                            ...
                            while($rs = mysql_fetch_array($result)){
                                ...
                                echo "<td align='center' scope='row'>
                                    ...
                                    onclick='$(\"#mensaje_equipos\").empty();"; 
                                echo "cargarDependencia(\"equipos_p2\",\"".$back."ventas/validacion/lista_equiposServicio.php\",\"".$rs['IdKServicioGFA']."\",\"check_serviciogfa_".$rs['IdKServicioGFA']."\",\"gfa\");";
                                echo"'/></td>";
                                ...
                                echo "<td align='center' scope='row'>"; 
                                echo "<a href='#' 
                                        onclick='cambiarContenidoServicio(\"div_servicioim\",\"ventas/validacion/alta_servicio_im.php?prefijo=GFA&&CC=$CC&Anexo=$ClaveAnexo\",
                                ...
                                echo "<td align='center' scope='row'>"; 
                                if($permisos_grid->tienePermisoEspecial($_SESSION['idUsuario'],17)){
                                    echo "<a href='#' onclick='eliminarServicioGFA(\"".$rs['IdKServicioGFA']."\",\"servicios_p2\",\"lista_servicios_parti.php\",\"$ClaveAnexo\",\"$CC\"); return false;'><img src=\"".$back."resources/images/Erase.png\"/></a>"; 
                                }
                                echo "</td>";
                                echo "</tr>";                            
                            }
