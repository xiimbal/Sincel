...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="<?php echo $back; ?>resources/js/paginas/validacion/alta_localidad.js"></script>
    </head>
    <body>        
        <fieldset>
            ...
            <form id="formLocalidad" name="formLocalidad" action="/" method="POST">
                ...
                <input type="submit" class="boton" id="cancelar" value="Cancelar" style="float: right; margin-right: 5px;" onclick="cambiarContenidoValidaciones('localidad2', '<?php echo $back; ?>ventas/validacion/lista_localidad.php?Nombre=<?php echo $NombreCodificado; ?>&Clave=<?php echo $ClaveGET; ?>', <?php
