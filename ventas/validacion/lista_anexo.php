...
<html lang="es">
    ...
    <body>        
        <fieldset>
            ...
            <img class="imagenMouse" src="<?php echo $back; ?>resources/images/add.png" title="Nuevo anexo" onclick='cambiarContenidoValidaciones("anexo2", "<?php echo $back; ?>ventas/validacion/alta_anexo.php?Nuevo=true&id=<?php echo $noContrato; ?>&idCliente=<?php echo $ClaveCliente; ?>", $("#idTicket").val(), null, true);
                ...
                if(mysql_num_rows($query) > 0){
                    ...
                    while ($rs = mysql_fetch_array($query)) {
                        ...
                        echo "<td align='center' scope='row'>
                            ...
                            echo "cargarDependencia(\"servicios_p2\",\"".$back."ventas/validacion/lista_servicios_parti.php\",\"".$rs['ClaveAnexoTecnico']."\",null,cc);";                            
                            echo "'/>
                            </td>";
                        ...
                        echo "<td align='center' scope='row'>"; 
                        echo "<a href='#' onclick='cambiarContenidoValidaciones(\"anexo2\",\"".$back."ventas/validacion/alta_anexo.php?id=$noContrato&idCliente=$ClaveCliente\", $(\"#idTicket\").val(),\"" . $rs['ClaveAnexoTecnico'] . "\",false); return false;'>";
