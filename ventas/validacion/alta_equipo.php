...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="<?php echo $back; ?>resources/js/paginas/validacion/alta_equipo.js"></script>
    </head>
    <body>        
        <fieldset>
            ...
            <form id="formEquipo" name="formEquipo" action="/" method="POST">
                ...
                <input type="submit" class="boton" value="Cancelar" style="float: right; margin-right: 5px;" onclick="cambiarContenidoValidaciones('equipo2', '<?php echo $back; ?>ventas/validacion/lista_equipo.php?NoSerie=<?php echo $NoSerieEquipoGET; ?>&Modelo=<?php echo $ModeloCodificado; ?>', '<?php echo $_POST['idTicket']; ?>', null);return false;"/>
                <?php
                    if(!$permiso){
