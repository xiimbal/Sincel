...
<html lang="es">
    ...
    <body>        
        ...
        <fieldset>
            ...
            <img class="imagenMouse" src="<?php echo $back; ?>resources/images/add.png" title="Nuevo equipo" 
                 onclick='cambiarContenidoValidaciones("equipos_p2", "<?php echo $back; ?>contrato/alta_equipo.php?noback=true&ind=true&prefijo=<?php echo $prefijo_menor; ?>&servicio=<?php echo $id; ?>&cliente="+$("#clave_cliente1").val()+"&id="+$("#clave_localidad1").val(),null, null, true);
                ...
                <table class="filtro" style="min-width: 100%;">
                    ...
                    <?php
                        while($rs = mysql_fetch_array($result)){
                            ...
                            echo "<a href='#' 
                                    onclick='cambiarContenidoServicio(\"equipos_p2\",\"".$back."ventas/validacion/altaEquipoServicio.php?Anexo=".$rs['ClaveAnexoTecnico']."&NoSerie=".$rs['NoSerie']."&IdKServicio=$id&prefijo=$prefijo_menor\",
