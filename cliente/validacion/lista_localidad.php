...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="../resources/js/paginas/validacion/lista_localidad.js"></script>        
    </head>
    <body>        
        <fieldset>
            <legend>Localidad</legend>
            <?php if($permisos_grid->tienePermisoEspecial($_SESSION['idUsuario'], 25)){ ?>
            <img class="imagenMouse" src="../resources/images/add.png" title="Nueva localidad" onclick='cambiarContenidoValidaciones("localidad2", "../cliente/validacion/alta_localidad.php?Nuevo=true&idCliente=<?php echo $_POST['id']; ?>&Nombre=<?php echo $NombreGET; ?>&Clave=<?php echo $_GET['Clave']; ?>", $("#idTicket").val(), null, true);
            ...
            if(mysql_num_rows($query) > 0){
                ...
                while ($rs = mysql_fetch_array($query)) {
                    ...
                    /*echo "cargarDependencia(\"domicilio2\",\"../cliente/validacion/lista_domicilio.php?idCliente=".$_POST['id']."\",\"".$rs['ClaveCentroCosto']."\",\"check_cc_".$rs['ClaveCentroCosto']."\",\"".$_POST["idTicket"]."\");
                          cargarDependencia(\"contrato2\",\"../cliente/validacion/lista_contrato.php\",\"".$rs['ClaveCliente']."\",\"check_cc_".$rs['ClaveCentroCosto']."\",\"".$_POST["idTicket"]."\"); '/></td>";*/
                    echo "cargarDependencia(\"contacto2\",\"../cliente/validacion/lista_contacto.php\",\"".$rs['ClaveCentroCosto']."\",\"check_cc_".$rs['ClaveCentroCosto']."\",\"".$_POST["idTicket"]."\");'/></td>";
                    ...
                    echo "<a href='#' onclick='cambiarContenidoValidaciones(\"localidad2\",\"../cliente/validacion/alta_localidad.php?idCliente=".$_POST['id']."&Nombre=".$NombreGET."&Clave=".$_GET['Clave']."\", $(\"#idTicket\").val(),\"" . $rs['ClaveCentroCosto'] . "\",false); return false;'>";
