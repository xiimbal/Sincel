...
<html lang="es">
    ...
    <body>        
        <fieldset>
            ...
            <img class="imagenMouse" src="../resources/images/add.png" title="Nuevo cliente" onclick='cambiarContenidoValidaciones("contacto2", "../cliente/validacion/alta_contacto.php?Nuevo=true&id=<?php echo $_POST['id'] ?>", $("#idTicket").val(), null, true);
            ...
            if(mysql_num_rows($query) > 0){
                ...
                while ($rs = mysql_fetch_array($query)) {
                    ...
                    if( ($rs['IdTipoContacto']!="15" && $rs['IdTipoContacto']!="13") || $permiso_contactos_facturacion){
                        echo "<a href='#' onclick='cambiarContenidoValidaciones(\"contacto2\",\"../cliente/validacion/alta_contacto.php?&id=".$_POST['id']."\", $(\"#idTicket\").val(),\"" . $rs['IdContacto'] . "\",false); return false;'>";
