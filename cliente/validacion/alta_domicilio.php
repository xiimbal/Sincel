...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" language="javascript" src="../resources/js/paginas/validacion/alta_domicilio.js"></script>
    </head>
    <body>        
        <fieldset>
            ...
            <form id="formDomicilio" name="formDomicilio" action="/" method="POST">
                ...
                <input type="submit" id="cancelar_domicilio" class="boton" value="Cancelar" style="float: right; margin-right: 5px;" onclick="cambiarContenidoValidaciones('domicilio2', '../cliente/validacion/lista_domicilio.php?idCliente=<?php echo $_GET['idCliente'] ?>',  <?php  if(isset($_POST['idTicket'])){ echo "'".$_POST['idTicket']."'";} else{ echo "null"; } ?>, '<?php echo $ClaveGET; ?>' ,null);return false;"/>
