        ...
        <fieldset style="max-width: 90%;">
            ...
            <form id="formCliente" name="formCliente" action="/" method="POST">
                <table style="width: 100%">                      
                    <tr>
                        <td><label for="nombre_cliente2">Nombre:<span class="obligatorio"> *</span></label></td>
                        <td><input type="text" id="nombre_cliente2" name="nombre_cliente2" class="complete" value="<?php echo $Nombre; ?>"/></td>
                    </tr>
                    <tr>
                        <td><label for="rfc_cliente2">RFC:<span class="obligatorio"> *</span></label></td>
                        <td>
                ...
                <input type="submit" class="boton" value="Cancelar" style="float: right; margin-right: 5px;" onclick=" cambiarContenidoValidaciones('cliente2', '../cliente/validacion/lista_cliente.php?Nombre=<?php echo $NombreCodificado; ?>&Clave=<?php echo $ClaveGET; ?>&NombreCentro=<?php echo $_GET['NombreCentro']; ?>&ClaveCentro=<?php echo $_GET['ClaveCentro']; ?>', <?php
