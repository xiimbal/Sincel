...
<html lang="es">
    ...
    <body>
        <div class="principal" style="max-width: 80%;">
            ...
            <div id="cliente2" style="max-width: 97%;">

            </div>
            <div id="mensaje_localidad2"></div>
            <div id="localidad2" style="max-width: 97%;">

            </div>
            <div id="mensaje_domicilio2"></div>
            <div id="domicilio2" style="max-width: 97%;">

            </div>
            <div id="mensaje_contacto2"></div>
            <div id="contacto2" style="max-width: 97%;">

            </div>
            <div id="mensaje_contrato2"></div>
            <div id="contrato2" style="max-width: 97%;">

            </div>
            <div id="mensaje_anexo2"></div>
            <div id="anexo2" style="max-width: 97%;">
