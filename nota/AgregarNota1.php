                    ...
                    if($parametroGlobal->getRegistroById(27) && $parametroGlobal->getActivo() == "1"){
                        if($tipoReporteTicket == 62){
                            ...
                            if(!$notaTicket->buscarNotaConArchivo()){
                                ...
                                echo "<h3>Este ticket de instalación no tiene un archivo adjunto agregado en ninguna nota, no se podrá cerrar el ticket</h3>";
                            }                            
                        }
                    }
                ?>
                        ...
                        <table id="nuevaRefaccion" style="width:70%">
                            ...
                            while ($contadorRef < count($idRefaccion)) {
                                ...
                                echo "<tr id='filaRefaccion_" . $contadorComp . "'>
                                    <td><span style='$style'>Refección : &nbsp;&nbsp;&nbsp;&nbsp;</span></td>
