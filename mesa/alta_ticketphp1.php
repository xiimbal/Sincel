...
if ($idTicket != "" && $tipoReporte != "") {
    ...
    $localidadEntrega = $obj->getlocalidadEntrega();
    // echo $claveLocalidad;
...
if ($noSerie != "") {//datos del equipo
    ...
    $querylocalidad= $catalogo->obtenerLista("SELECT Nombre FROM c_centrocosto WHERE ClaveCentroCosto='$localidadEntrega'");
     while ($rs = mysql_fetch_array($querylocalidad)) {
        $localidadEntrega = $rs['Nombre'];
    }
}
$listaNoSeries = "";
    ...
    <!--                                                            <input type="text" id="txtZonaToner" name="txtZonaToner" value="" style='width: 180px' />
     ...
     <hr width="100%" size="20" />                     
            <legend>Datos del <?php echo $nombre_objeto; ?></legend>    
                                ...
                                <?php
                                if ($tipoReporte == "15" && $claveCliente != "" ) { ?>
                                <label>Localidad de entrega:</label>
                                <select class='form-control' id="localidadEntrega" name="localidadEntrega" >
                                    <?php
                                    if ($idTicket != "") {
                                        $queryCliente = $catalogo->obtenerLista("SELECT cc.ClaveCentroCosto,cc.Nombre FROM c_centrocosto cc WHERE cc.ClaveCliente='$claveCliente' AND cc.Activo=1 ORDER BY cc.Nombre ASC;");
                                        echo " <option value='0'>Seleccione una localidad</option>";
                                        while ($rs = mysql_fetch_array($queryCliente)) {
                                            $s = "";
                                            if ($localidadEntrega != "" && $localidadEntrega == $rs['ClaveCentroCosto']) {
                                                $localidadEntrega = $rs['Nombre'];
                                                $s = "selected";
                                            }                                               
                                            echo "<option value=" . $rs['ClaveCentroCosto'] . " " . $s . ">" . $rs['Nombre'] . "</option>";
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <?php
                                $result2 = $catalogo->obtenerLista("SELECT pt.IdPrioridad, pt.Prioridad, tp.TipoPrioridad,  c.Hexadecimal FROM `c_prioridadticket` AS pt LEFT JOIN c_color AS c ON c.IdColor = pt.IdColor LEFT JOIN c_tipoprioridad AS tp ON tp.IdTipoPrioridad = pt.IdTipoPrioridad WHERE pt.Activo = 1;");
                        ...
                        <div class="form-group col-md-4">
                             <label>Nombre</label>
                                        ...
                                        <div id="contactoNuevo">
                                            <input class="form-control" type="text" id="txtNombre1" name="txtNombre1" value="<?php echo $nombreResp; ?>"  display: none;' <?php echo $read; ?> readonly="readonly"/>
                                        </div>
</div>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                                   ...
                                   <div class="form-group col-md-3">
                                        <label for="lstHA">Horario de atención</label><br>
                                        <?php
                                        $hinicioResp = "";
                                        $minicioResp = "";
                                        $tinicioResp = "";
                                        ...
                                        ?>
                                        <label for="lstHR">Hora de inicio:</label><br>
                                    ...
                                    <div class="form-group col-md-3">
                                    <legend></legend><br>
                                    <label for="lstFinR">Hora de fin:</label><br>
        ...
        <hr width="100%" size="20" />                
                            <legend>Contacto de atención del <?php echo $nombre_objeto; ?></legend>   
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" type="text" id="txtNombreAtencion" name="txtNombreAtencion" value="<?php echo $nombreAtencion; ?>" <?php echo $read; ?>/>
                                </div>
                                <div class="form-group col-md-4">
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" type="text" id="txtTelefono1Atencion" name="txtTelefono1Atencion" value="<?php echo $telefono1Atencion; ?>"<?php echo $read; ?>/>
                                </div>
                                <div class="form-group col-md-3">
                                    <label  for="txtExtencion2Atencion">Extención 1:</label>
                                    <input class="form-control" type="text" id="txtExtencion2Atencion" name="txtExtencion2Atencion" value="<?php echo $Extencio2Atencion; ?>"  <?php echo $read; ?>/>
                                    </div>
                                <div class="form-group  col-md-3">
                                     <label  for="txtExtencion1Atencion">Extención 2:</label>
                                     <input class="form-control" type="text" id="txtExtencion1Atencion" name="txtExtencion1Atencion" value="<?php echo $Extencio1Atencion; ?>"  <?php echo $read; ?>/>
                                </div>
                                <div class="form-group col-md-3">
                                    <label  for="txtTelefono2Atencion">Telefono 2:</label>
                                    <input class="form-control" type="text" id="txtTelefono2Atencion" name="txtTelefono2Atencion" value="<?php echo $telefono2Atencion; ?>"  <?php echo $read; ?>/> 
                                    </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" type="text" id="txtCelularAtencion" name="txtCelularAtencion" value="<?php echo $celularAtencion; ?>" <?php echo $read; ?>/>
                                </div>
                                ...
                                <div class="form-group  col-md-3">
                                    ...
                                    <input class="form-control" type="text" id="txtCorreoElectronico" name="txtCorreoElectronico" value="<?php echo $correoAtencion; ?>" <?php echo $read; ?>/>
                                ...
                                <div class="form-group  col-md-3"> 
                                 <label>Hasta:</label><br>
                                    <label for="lstFinA">Fin:</label> <br>
                                    <label>Hora:</label>
                        ...
                        <div class="form-group col-md-4">
                             <label>No. <?php echo $nombre_objeto; ?> cliente:</label>
                        ...
                        <div class="form-group  col-md-4"> 
                               <label> No. Guía</label>
                                <input class="form-control" type="text" id="noGuia" name="noGuia" value='<?php echo $NoGuia ?>'>
                            </div>   
