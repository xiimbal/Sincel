    ...
    <body>
        <div class="principal">            
                <div class="container-fluid">    
                    ...
                    <div class="form-group col-md-4">
                         <label> <?php if(!empty($where)){echo "Cuadrante";}else{echo "Áreas de atención  $nombre_objeto";} //&Aacute?></label><br> 
                         <select class="form-control" id="area" name="area" class="select">
                            <?php
                            /* Inicializamos la clase */
                     ...
                     <div class="form-group  col-md-4">
                        ...
                        <label>Mostrar morosos</label><br>
            ...
            <div style="width: 100%;">
                    ...
                    <div style="vertical-align: text-top; width: 100%;"><!--Aqui se pone el mapa-->                        
                    ...
                    <td>
                        ...
                        if ( isset($_POST['idTicket'])) {
                            ...
                            ?>
                    <br/><br/>
                            <table id="tAsigna" class="table-responsive">
                                <thead>
                                    <tr>
                                        <?php
                                ...
                                <tbody>
                                    ...
                                    if(!empty($where)){
                                        ...
                                        $src_destino = "viajes/ConsultaDestino.php?destino=".$rs['LugarDestino']."&IdTicket=" . $rs['IdTicket'];?>
                                    <td>
                                        <a href='#' title='Destino' onclick='lanzarPopUpAjustable("Destino Ticket <?php echo $rs['IdTicket']; ?>", "<?php echo $src_destino; ?>","700","250");
