            ...
            <form action="reportes/ReporteTicketsExcel.php" method="post" target="_blank" id="FormularioExportacion">
                <table style="width: 100%;">        
                    ...
                    <tr>        
                        ...
                        <td><input type="checkbox" id="ticket_cerrado" name="ticket_cerrado" <?php echo $checked; ?> /><?php echo $nombre_objeto; ?>es cerrados</td>
                        ...
                        <td></td>
                        <td></td>
                        <td><input type="checkbox" id="ticket_cancelado" name="ticket_cancelado" <?php echo $checkedCancelado; ?> /><?php echo $nombre_objeto; ?>es cancelados</td>
                    </tr>                
                    <tr>
                        <td>Cliente</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <input type="button" class="button" onclick="recargarListaTicket('mesa/lista_ticket_pakal.php', 'ticket_cerrado', 'cliente_ticket', 'ticket_color',
                                    ...
                                    return false;" id="boton_aceptar" name="boton_aceptar" value="Mostrar <?php echo $nombre_objeto; ?>es"/>
                        </td>
                        <td>
            ...
            if ((isset($_POST['mostrar']) && $_POST['mostrar'] == "true") || (isset($_GET['mostrar']) && $_GET['mostrar'] == "true") || $idTicket != "") {/* Si se quiere mostrar el grid */
                ...
                <table id="tAlmacen" class="reporte" >
                    <thead>
                        <tr>
                            ...
                            for ($i = 0; $i < (count($cabeceras)); $i++) {
                                echo "<th align=\"center\" style=\"width:.01%\" scope=\"col\">" . $cabeceras[$i] . "</th>";
                            }
                            ?>                        
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        echo "<td scope='row' style='text-align: center;'><a onclick='eliminarCamion(".$rs['IdTicket']."); return false;' style='cursor: pointer;'><img src='resources/images/Erase.png'/></a></td>";
                        echo "</tr>";
                    }
                    ?>
                    </tbody>
