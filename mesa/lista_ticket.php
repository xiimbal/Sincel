        ...
        <div class="principal">            
            ...
            <form action="reportes/ReporteTicketsExcel.php" method="post" target="_blank" id="FormularioExportacion">
                ...
                <div class="form-row">       
                    ...
                    <div class="form-group col-md-4">
                      <label><?php echo $Titulo_NoSerie; ?></label>
                         <input class="form-control" id="num_serie" name="num_serie" value="<?php echo $NoSerie; ?>" />
                      </div>
                           
                    <div class="form-group col-md-4">
                      <label><?php echo $Titulo_AreaAtencion; ?></label>
                    ...
                    <div class="form-group col-md-4">
                      <label>SubEstado</label>
                        ...
                        <div class="form-group col-md-4">
                            <label class="m-0">Filtrar2:</label><br>
                            <input type="checkbox" id="ticket_cerrado" name="ticket_cerrado" <?php echo $checked; ?> />
                            <label><?php echo $nombre_objeto; ?>s cerrados</label><br>
                            ...
                            <label><?php echo $nombre_objeto; ?>s cancelados</label>
                        </div>                
                        <div class="form-group col-md-4">
                             <label>Cliente</label>
                             <select class="form-control" multiple  class="form-control" id="cliente_ticket" name="cliente_ticket[]"  >
                                <?php
                                if(!empty($negocios)){
                            ...
                            <input type="button" class="button btn btn-lg btn-block btn-outline-primary mt-3 mb-3" onclick="recargarListaTicket('mesa/lista_ticket.php', 'ticket_cerrado', 'cliente_ticket', 'ticket_color',
                            ...
                            <?php if ((isset($_POST['mostrar']) && $_POST['mostrar'] == "true") || (isset($_GET['mostrar']) && $_GET['mostrar'] == "true")) { ?>
                                <input type="button" class="button btn btn-lg btn-block btn-outline-success mt-3 mb-3" title="Exportar a excel" id="excelSubmit" name="excelSubmit" value="Exportar a excel" onclick="submitform()"/>
                                <input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />                                            
                            <?php } ?>
                       
                        <td>
                            <?php if(isset($_GET['regresar']) && $_GET['regresar'] != ""){ ?>
                            <input type='button' class='button' title='Regresar' value='Regresar' onclick='cambiarContenidos("<?php echo $_GET['regresar']?>","")'>
                            <?php } ?>
                        </td>
                    </tr>
                </div>  
            ...
            if ((isset($_POST['mostrar']) && $_POST['mostrar'] == "true") || (isset($_GET['mostrar']) && $_GET['mostrar'] == "true") || $idTicket != "") {/* Si se quiere mostrar el grid */
                if ($permiso_detalle_servicio) {
                    ?>
                    <a href="mesa/DetalleServicios.php<?php echo $urlextra ?>" target="_blank" class="button btn btn-lg btn-block btn-outline-secondary mt-3 mb-3">Generar excel</a> 
                            <?php } ?>
                    ...
                    <tbody>
                        ...
                        if ($idTicket == "") {
                            $consulta = "SELECT
                                ...
                                cz.NombreZona AS ubicacionTicket,
                                ...
                                $tecnico
                                LEFT JOIN c_centrocosto AS cco ON cco.ClaveCentroCosto=t.ClaveCentroCosto
                                LEFT JOIN c_domicilio AS cd ON cd.ClaveEspecialDomicilio = cco.ClaveCentroCosto
                                LEFT JOIN c_zona AS cz ON cz.ClaveZona = cd.ClaveZona
                                $Where
                                $groupBy
                                $having
                                ORDER BY IdTicket";
                            ...
                            $consulta = "SELECT
                                ...
                                e2.Nombre AS area,
                                e2.IdEstado AS idArea,
                                cgz.NombreZona AS ubicacionTicket,
                                e3.Nombre AS estadoNota,
                                nt.IdEstatusAtencion,
                                nt.DiagnosticoSol,
                                nt.FechaHora AS FechaNota,
                                ...
                                LEFT JOIN c_domicilioticket AS dt ON dt.IdTicket = t.IdTicket
                                LEFT JOIN c_cliente AS cl2 ON t.ClaveCliente = t.ClaveCliente
                                LEFT JOIN c_zona AS cgz ON cgz.ClaveZona = cl2.ClaveZona
                        ...
                        while ($rs = mysql_fetch_array($query)) {/* Recorremos todos los tickets resultantes del query */
                            ...
                            $total= $total-1;
                            echo "<td align='center' scope='row'>" . $total . "</td>";
