...
<html lang="es">
    ...
    <body>
        ...
        <input type="submit" class="button" style="float: right;" value="Cancelar" onclick="cambiarContenidos('mesa/lista_ticket.php?page=<?php echo $_POST['page'] ?>&filter=<?php echo $filter; ?>');
                return false;"/>
        <br/><br/><br/>
    </body>
</html>