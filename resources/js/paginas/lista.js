...
/*Comentado por cambio de estilo a Boostrap v4
...
function mostrarComponentesAlmacenConProveedor(liga, tipo,tipoProv, almacen, modelo) {
    loading("Cargando ...");
    /*Procesamos los clientes que vengan concatenados*/
    var res = $("#" + almacen).val();
    var almacenes = "";
    ...
    $("#contenidos").load(liga, {'tipoComponente': $("#" + tipo).val(),'Proveedor': $("#" + tipoProv).val(), 'almacenes': almacenes, 'modelo': $("#" + modelo).val(), 'mostrar': true}, function () {
        $(".button").button();
        finished();
    });
}
