...
$(document).ready(function() {
    ...
    var paginaExito = "compras/lista_orden_compra.php";
    var controlador = "WEB-INF/Controllers/compras/Controler_Orden_Compra.php";
            ...
            $.post(controlador, {form: $(form).serialize(), "tbComponente": tbComponente, "tbEquipo": tbEquipo, "arrayCompiDetalle": arrayCompiDetalle}).done(function(data) {
                if (data.toString().indexOf("Error:") === -1) {
                    ...
                    if ($("#file_name").length && $("#file_name").val() != "") {
                        ...
                        setTimeout(function() {
                            window.location = "principal.php?mnu=compras&action=lista_orden_compra&id=" + id_compra;
                        }, 3000);
                    }
                } else {
                    $('#mensajes').html(data);
