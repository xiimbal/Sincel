$(document).ready(function () {
    ...
    $(form).validate({
        ...
        messages: {
            ...
            usoCFDI: {required: " * Selecciona un uso para el CFDI"},
        ...
        if ($(form).valid()) {
            ...
            $.post(controlador, {form: $(form).serialize()}).done(function (data) {
                if (data.toString().indexOf("Error:") === -1) {
                    ...
                    if ($("#ndc").length && $("#ndc").val() == "1") {
                        cambiarContenidos("facturacion/alta_factura_33.php?id=" + res[0] + "&param1=egreso&nuevo=true", "Facturación 3.3");
                    } else {
                        cambiarContenidos("facturacion/alta_factura_33.php?id=" + res[0], "Facturación 3.3");
                    }
...
function agregarPeriodo() {
    ...
    $("#t_datos_grales").append("<tr id='table_row_" + numero_periodos + "'><td></td><td></td><td></td>" +
            ...
            "<input type='image' src='resources/images/add.png' title='Agregar otro periodo' onclick='agregarPeriodo(); return false;' style='margin-bottom: -10px;'/>" +
