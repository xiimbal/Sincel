        ...
        onDblClick: function(node) {
            ...
            if (n.substring(0, 4) === "cli%") {
                $("#divinfoup").html(
                        ...
                        + "</div>" + "<br/><div align='right'><a href='#' onclick=\"lanzarPopUp('Lectura corte', 'contrato/lecturas_corte.php?cliente=" + n.substring(4, n.length) + "'); return false;\">Lecturas de corte</a></div>");
            } else {
                n = node.id + ""
                n = n.substring(0, 2);
                if (n != "no") {
                    ...
                    if (n != "lo%") {
                        ...
                        $("#divinfo").load(direccion, {id: n}, function() {
                            $("#divinfoup").html(
                                    ...
                                    + "</div><br/>"
                                    + "<div align='right'>"
                                    + "<a href='#' onclick=\"lanzarPopUp('Lecturas de corte', 'contrato/lecturas_corte.php?id=" + n + "'); return false;\">Lecturas de corte</a>"
                                    + "</div>");
                        });
                    }
                }
...
function cargarclientes(origen, componente) {
    $("#" + componente).load("WEB-INF/Controllers/Ventas/Controller_select_clientes.php", {cliente: $("#" + origen).val(), tipo: 1}, function(data) {
