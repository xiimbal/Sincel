...
$same_page = "catalogos/lista_series_pagos.php";
...
<?php if ($permisos_grid->getAlta()) { ?>
    <img class="imagenMouse" src="resources/images/add.png" title="Nuevo" onclick='cambiarContenidos("catalogos/alta_serie_pago.php", "Nueva Serie");' style="float: right; cursor: pointer;" />  
<?php } ?>
<br/><br/><br/>
<table id="tserie">
    <thead>
    ...
    <tbody>
        ...
        $query = $serieClase->buscarTodoPago();
        while ($rs = mysql_fetch_array($query)) {
            ...
            if ($permisos_grid->getModificar()) {
                echo "<td width=\"2%\" align=\"center\" scope=\"row\"><a href='#' onclick=\"cambiarContenidos('catalogos/alta_serie_pago.php?id=" . $rs['IdSerie'] . "', 'Editar Serie');
            ...
            if ($permisos_grid->getBaja()) {
                echo "<td width=\"2%\" align=\"center\" scope=\"row\"><a href='#' onclick=\"eliminarSeriePago('".$rs['IdSerie']."');
