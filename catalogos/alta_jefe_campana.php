...
$pagina_lista = "catalogos/lista_jefe_campana.php";
...
<!--                        <td><label for="puesto">Puesto</label></td>
                        ...
                        <?php echo "<input type='hidden' id='puesto' name='puesto' value='102'/> "; ?>
                    </tr>
                    <tr>
                ...
                <input type="submit" class="boton" value="Cancelar" onclick="cambiarContenidos('<?php echo $pagina_lista; ?>');
                       ...
                       echo "<input type='hidden' id='NoAlta' name='NoAlta' value='4'/> ";
                       ?>
            </form>
        </div>
    </body>
