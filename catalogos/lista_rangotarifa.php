...
$same_page = "catalogos/lista_rangotarifa.php";
$permisos_grid->getPermisosSubmenu($_SESSION['idUsuario'], $same_page);
$controlador = "WEB-INF/Controllers/Controler_RangoTarifa.php";

$cabeceras = array("Tarifa", "", "");
$columnas = array("Tarifa", "IdTarifa");
$alta = "catalogos/alta_rangotarifa.php";
?>
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <div class="principal">
            ...
            <table id="tAlmacen" class="tabla_datos">
                ...
                <tbody>
                    ...
                    $query = $catalogo->getListaAlta("c_tarifarango", "Tarifa");
                    while ($rs = mysql_fetch_array($query)) {
                        echo "<tr>";
                        for ($i = 0; $i < count($columnas) - 1; $i++) {
                            echo "<td width=\"2%\" align='center' scope='row'>" . $rs[$columnas[$i]] . "</td>";
                        }
                        ?>
