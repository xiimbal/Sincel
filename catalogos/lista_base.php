...
$same_page = "catalogos/lista_base.php";
$permisos_grid->getPermisosSubmenu($_SESSION['idUsuario'], $same_page);
$controlador = $_SESSION['ruta_controler'] . "Controler_Base.php";

$cabeceras = array("Nombre", "Descripción", "", "");
$columnas = array("Nombre", "Descripcion","IdBase");

$alta = "catalogos/alta_base.php";
        ...
        <div class="principal">
            ...
            <table id="tAlmacen" class="tabla_datos" style="max-width: 100%;">
                ...
                <tbody>
                    ...
                    $query = $catalogo->getListaAlta("c_base_operador", "Nombre");
