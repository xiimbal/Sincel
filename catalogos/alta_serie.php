...
if (isset($_GET['id']) && $_GET['id']) {
    $serie->getRegistroById($_GET['id']);
    $prefijo = $serie->getPrefijo();
    $folioInicio = $serie->getFolioInicio();
    $activo = $serie->getActivo();
}
?>
<script type="text/javascript" language="javascript" src="resources/js/paginas/catalogos/alta_serie.js"></script>
<form id="formSerie">
...
<?php } ?>
    ...
    <input type="button" id="cancelar" class="boton" name="cancelar" value="Cancelar" onclick="cambiarContenidos('catalogos/lista_series.php', 'Serie');"/>
</form>
