...
$same_page = "catalogos/lista_coordinador.php";
...
$tabla = "c_usuario";
$order_by = "loggin";
$alta = "catalogos/alta_coordinador.php";
            ...
            <table id="tAlmacen" class="tabla_datos">
                ...
                <tbody>
                    ...
                    $query = $catalogo->obtenerLista("SELECT idUsuario, Loggin, CONCAT(usu.Nombre,' ',usu.ApellidoPaterno,' ',ApellidoMaterno) AS nombre_completo,
							...
							WHERE  per.IdPuesto = usu.IdPuesto AND per.IdPuesto!=14 AND usu.IdPuesto=103 ORDER BY usu.Nombre ASC;");
