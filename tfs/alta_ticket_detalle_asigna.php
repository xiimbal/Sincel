...
<html lang="es">
    ...
    <body>
        ...
        <input type="submit" class="button" style="float: right;" value="Cancelar" onclick="cambiarContenidos('tfs/mis_tickets_asigna.php?page=<?php echo $_POST['page'] ?>&filter=<?php echo $filter; ?>');return false;"/>
        <br/><br/><br/>
    </body>
</html>