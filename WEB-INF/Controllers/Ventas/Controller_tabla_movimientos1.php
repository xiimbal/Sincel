    ...
    <table id="tAlmacen" style="width: 100%;">
        ...
        <tbody>
            ...
            while ($rs = mysql_fetch_array($query)) {/* Recorremos todos los tickets resultantes del query */
                ...
                echo "<td align='center' scope='row'>" . $rs['cliente_anterior'] . "</td>";
                echo "<td align='center' scope='row'>" . $rs['centro_anterior'] . "</td>";
                echo "<td align='center' scope='row'>" . $rs['cliente_nuevo'] . "</td>";
                echo "<td align='center' scope='row'>" . $rs['centro_nuevo'] . "</td>";
                echo "<td align='center' scope='row'>" . $rs['almacen_anterior'] . "</td>";
                echo "<td align='center' scope='row'>" . $rs['almacen_nuevo'] . "</td>";
