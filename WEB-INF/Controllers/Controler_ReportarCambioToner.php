...
//                }
                ...
                if ($idTicket != "" || (!isset($_POST['autorizar']) && $ticket->newRegistro())) {
                    ...
                    //Se modifico el diagnostico 11-04-19 KIKE
                    $usuario = new Usuario();
                    if ($usuario->getUsuarioByUser($_SESSION['user'])) {
                        $notaTicket->setDiagnostico(" Solicitud de cambio de toners. Ticket abierto por " . $usuario->getNombre() . " " . $usuario->getPaterno() . " " . $usuario->getMaterno());
                    }
