...
$arr_fac = explode("_", $facturas);//arreglo de las facturas
$tam = sizeof($arr_fac);
$tam= $tam - 1;//cantidad de facturas
...
$arr_pagos = explode("_", $pagosFac);
$arr_salAnt = explode("_", $saldoAntFac);
