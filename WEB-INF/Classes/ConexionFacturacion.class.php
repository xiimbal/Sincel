...
class ConexionFacturacion {
    ...
    public function Conectar() {        
        ...
        $consulta = "SELECT b.ip_base, b.login_base, b.pass_base, b.nombre_base 
                ...
                WHERE e.id_empresa = $this->empresa AND e.Activo = 1 AND b.Activo = 1 AND b.tipo_base = 2;";
        ...
        /*$MYSQL_HOST = "166.78.239.16";
        $MYSQL_DB = "romeos_facturacionphp";
        $MYSQL_LOGIN = "root";
        $MYSQL_PASS = "smucdb28";*/
        
        /* techra */
        /*$MYSQL_HOST = "50.31.138.92";
        $MYSQL_DB = "genesis_fpruebas";
