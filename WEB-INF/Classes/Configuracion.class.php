...
include_once ("SolicitudBitacora.class.php");
...
class Configuracion {
    ...
    public function desasociarBitacora($idBitacora, $IdSolicitud) {
        ...
        if ($query == 1) {
            ...
            $solicitudBitacora = new SolicitudBitacora();
            if (!$solicitudBitacora->deleteRegistro($idBitacora, $IdSolicitud)) {
                return false;
            }
            return true;
        }
    ...
    public function newRegistroRapido() {
        ...
        $solicitudBitacora = new SolicitudBitacora();
        $solicitudBitacora->setId_bitacora($this->id_bitacora);
        $solicitudBitacora->setId_solicitud($this->id_solicitud);
        $solicitudBitacora->setNoParte($this->NoParte);
        $solicitudBitacora->setClaveCentroCosto($this->ClaveCentroCosto);
        $solicitudBitacora->setActivo(1);
        $solicitudBitacora->setUsuarioCreacion($this->UsuarioCreacion);
        $solicitudBitacora->setUsuarioUltimaModificacion($this->UsuarioUltimaModificacion);
        $solicitudBitacora->setPantalla($this->Pantalla);
        if ($solicitudBitacora->newRegistro()) {
            return true;
        }
    ...
    public function editarRegistro() {
        ...
        $consulta = "SET foreign_key_checks = 0;
            UPDATE c_bitacora SET id_solicitud = $this->id_solicitud, NoParte = '$this->NoParte',
