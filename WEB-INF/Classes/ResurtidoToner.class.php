...
class ResurtidoToner {
    ...
    public function getTabla() {
        ...
        if (isset($this->idTicket) && $this->idTicket != "") {
            ...
            /*nt1.FechaHora AS fechaComponente,*/
            ...
            LEFT JOIN c_notaticket AS nt ON nt.IdTicket = c_ticket.IdTicket AND nt.IdEstatusAtencion = 67
            ...
            FROM c_notaticket 
            LEFT JOIN k_nota_refaccion ON k_nota_refaccion.IdNotaTicket = c_notaticket.IdNotaTicket 
             WHERE IdTicket = c_ticket.IdTicket AND IdEstatusAtencion = 66 AND k_nota_refaccion.NoParteComponente = k_resurtidotoner.NoComponenteToner)*/
            ...
            FROM c_ticket
            LEFT JOIN c_mailpedidotoner AS mpt ON mpt.idTicket = c_ticket.IdTicket 
            INNER JOIN c_pedido ON c_pedido.IdTicket = c_ticket.IdTicket AND nt.IdEstatusAtencion = 67
