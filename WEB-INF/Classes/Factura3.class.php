 ...
 * @author *JT
 * Se creo cre una nueva clase porque generaba error en lasclases factura.class y PagoParcial.class
 */
class Factura_NET3{
    ...
    /**
     * Marca como pagadas las facturas que estÃ¡n como no pagadas pero ya no tienen importe por pagar.
        ...
        if ($mandarmail && $facturas != "") {//Si hay que mandar mail
            ...
            foreach ($correos as $value) {/* Lo mandamos a los correos de los usuarios de cuentas por cobrar */
                ...
                if ($mail->enviarMail() == "1") {
                    //echo "<br/>Un correo fue enviado por resumen global de facturaciÃ³n a $value.";
                } else {
    ...
    /**
     * Regresa el folio maximo (mÃ¡s uno) de la razon social especificada
     * @param type $RFCEmisor RFC de la razÃ³n social
     * @return type entero con el maximo folio mÃ¡s uno insertado
     */
