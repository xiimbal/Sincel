        ...
        <div class="principal">            
            ...
            <table id="tAlmacen" class="tabla_datos">
                ...
                <tbody>
                    ...
                    $consultita = "";
                    if ($where === "") {
                        $consultita = "SELECT ce.idTicket, ce.idEspecial, ce.idUsuario AS NoEmpleado, cu.Nombre, cu.ApellidoPaterno AS ApellidoPa,
                    ...
                    $query = $catalogo->obtenerLista($consultita);
