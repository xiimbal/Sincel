                                ...
                                <tr>
                                    <td>
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="hora"></label>Hora<span class="obligatorio"> *</span>
                                                    <?php                                                        
                                                        $hr = split(":",$hora);                                                        
                                                    ?>
                                                    <select id="hora" name="hora" required="required" style="width: 50px;">
                                                        <?php for($i=0;$i<=23;$i++){
                                                            $s = "";
                                                ...
                                                <td>
                                                    <label for="minuto"></label>Minuto<span class="obligatorio"> *</span>
                                                    <select id="minuto" name="minuto" required="required" style="width: 50px;">
                                                        <?php for($i=0;$i<=59;$i++){
                                                            $s = "";
                                                            if((int)$hr[1] == $i){
                                                                $s = "selected='selected'";
